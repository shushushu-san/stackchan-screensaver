...
> **Windows 版は `../windows-saver/` に C# / WinForms で実装済み**です（詳細は [`../windows-saver/readme-windows.md`](../windows-saver/readme-windows.md)）。
...
> **A Windows version is also available** in `../windows-saver/` (C# / WinForms). See [`../windows-saver/readme-windows.md`](../windows-saver/readme-windows.md).
